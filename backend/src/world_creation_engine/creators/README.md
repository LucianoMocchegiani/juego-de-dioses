...
Parte del **motor de creación del mundo** (`world_creation_engine/`). Este documento explica cómo funcionan los creators y el flujo completo de creación de entidades.
