...
Parte del **motor de creación del mundo** (`world_creation_engine/`). Este documento explica cómo funciona el sistema de templates, builders y creators, y cómo agregar nuevos tipos de entidades.
...
```
backend/src/world_creation_engine/
├── templates/
...
```python
from src.world_creation_engine.templates.trees.nuevo_arbol import NuevoArbolTemplate
...
```python
from src.world_creation_engine.templates.bipedos.nuevo_biped import NuevoBipedTemplate
...
```python
from src.world_creation_engine.templates.plants.base import PlantTemplate
...
from src.world_creation_engine.templates.plants.base import PlantTemplate
from src.world_creation_engine.templates.plants.rosa import RosaTemplate
...
```python
from src.world_creation_engine.builders.plant_builder import PlantBuilder
