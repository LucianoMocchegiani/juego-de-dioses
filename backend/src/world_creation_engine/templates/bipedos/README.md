...
Parte del **motor de creación del mundo** (`world_creation_engine/`). Contiene templates para crear personajes bípedos (humanos, elfos, enanos, etc.) usando el sistema de templates/builders/creators.
...
3. Registrar en `registry.py`:
   ```python
   from src.world_creation_engine.templates.bipedos.nuevo_template import NuevoTemplate
