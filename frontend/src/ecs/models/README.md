...
**Nota**: Este módulo fue migrado desde `renderers/models/` a `ecs/models/` como parte de la refactorización JDG-035-3, ya que solo es usado por sistemas ECS.
...
**Uso:**
```javascript
import { mapBonesToBodyParts, findBone, setBoneVisibility } from './models/bones-utils.js';
