...
- `frontend/src/app.js` - Integración del sistema de debugging, inicialización de herramientas y exposición en `window.developmentTools`
...
- Todas las herramientas se exponen globalmente en `window.developmentTools` solo en desarrollo
...
- [x] Verificado que `window.developmentTools` está disponible en desarrollo
...
- [x] Verificar que `window.developmentTools` no está disponible en producción
